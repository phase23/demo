...
public class SDK_Result extends MainActivity {
    ...
    public static String obtainCardInfo(Context context, CardInfoEntity cardInfoEntity) {
        ...
        String track1 = cardInfoEntity.getTk1();
        String track2 = cardInfoEntity.getTk2();
        String track3 = cardInfoEntity.getTk3();
        String expireit = cardInfoEntity.getExpiredDate();
        String newline = System.getProperty("line.separator");


            AlertDialog.Builder builder1 = new AlertDialog.Builder(context);
            builder1.setMessage("cardno :" + cardno + newline +
                                 "track1 :" + track1 + newline +
                                 "track 2 :" + track2 + newline +
                                  "track3: " + track3 + newline +
                                  "expire: "+ expireit + newline);
        ...
        sb.append("Resultcode:\t" + cardInfoEntity.getResultcode() + "\n")
                ...
                .append(cardInfoEntity.getRfCardType() == null ? "" : "Rf card type:\t" + new String(cardInfoEntity.getRfCardType()) + "\n")
