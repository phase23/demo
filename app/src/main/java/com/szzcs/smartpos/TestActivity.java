...
public class TestActivity extends AppCompatActivity implements DialogInterface.OnCancelListener {


    private static final String TAG = "TestActivity";
    ActionBar actionBar;
    @BindView(R.id.led_test_result) TextView ledTestResult;
    @BindView(R.id.beeper_test_result) TextView beeperTestResult;
    @BindView(R.id.rf_test_result) TextView rfTestResult;
    @BindView(R.id.ic_test_result) TextView icTestResult;
    @BindView(R.id.mag_test_result) TextView magTestResult;
    @BindView(R.id.psam1_test_result) TextView psam1TestResult;
    @BindView(R.id.psam2_test_result) TextView psam2TestResult;
    @BindView(R.id.scan_test_result) TextView scanTestResult;
    @BindView(R.id.print_test_result) TextView printTestResult;
    @BindView(R.id.start_test) Button startTest;
    @BindView(R.id.m1_test_result) TextView mM1TestResult;
    @BindView(R.id.pin_keyboard) EditText mPinKeyboard;
    @BindView(R.id.security_test_result) TextView mSecurityTestResult;
    @BindView(R.id.puk_test_result) TextView mPukTestResult;
